...
public class Race extends JFrame implements ActionListener {
    ...
    private void startRace(Graphics g) {
         ...
         * kunt initialiseren.
         */
        h1 = new Paard("Moonshine", Color.orange);
        h2 = new Paard("Sunlight", Color.blue);
        h3 = new Paard("Toska", Color.pink);
        h4 = new Paard("klavertje4", Color.green);
